...
|----------|-------------|
| `OPENROUTER_API_KEY` | OpenRouter API key for model routing, OpenRouter TTS, and OpenRouter Transcriptions |
...
| `KAGI_API_KEY` | Kagi API key for premium web search and markdown extraction ([kagi.com/api](https://kagi.com/api)) |
...
| `STT_OPENROUTER_MODEL` | Override the OpenRouter STT model (default: `openai/whisper-large-v3`) |
| `OPENROUTER_STT_BASE_URL` | Override the OpenRouter STT endpoint |
...
| `SPRITES_TOKEN` | Sprites persistent Linux sandboxes ([sprites.dev](https://sprites.dev/)) |
...
| Variable | Description |
|----------|-------------|
| `TERMINAL_ENV` | Backend: `local`, `docker`, `ssh`, `singularity`, `modal`, `daytona`, `sprites` |
